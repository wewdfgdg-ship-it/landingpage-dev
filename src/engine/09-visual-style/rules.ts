...
export const MOOD_DEFS: readonly MoodDef[] = [
  {
    id: 'luxury',
    name: 'Luxury',
...
export const POSITIONING_KEYWORDS: readonly {
  keywords: string[];
  moods: MoodPreset[];
}[] = [
  { keywords: ['프리미엄', '고급', '럭셔리'], moods: ['luxury', 'premium'] },
  { keywords: ['혁신', '기술', '테크'], moods: ['tech', 'startup'] },
  { keywords: ['친근', '재미', '젊은'], moods: ['fun_pop', 'startup'] },
  { keywords: ['미니멀', '심플', '깔끔'], moods: ['minimal', 'clean'] },
  { keywords: ['전문', '신뢰', '안정'], moods: ['professional', 'premium'] },
] as const;

// --- 라디우스 프리셋 ---

export const RADIUS_PRESETS: Record<'sharp' | 'rounded' | 'pill', RadiusScale> = {
  sharp: { none: 0, sm: 2, md: 4, lg: 6, xl: 8, full: 999 },
  rounded: { none: 0, sm: 4, md: 8, lg: 12, xl: 16, full: 999 },
  pill: { none: 0, sm: 8, md: 12, lg: 16, xl: 24, full: 999 },
} as const;
...
export const SECTION_PADDING = '80px 0' as const;

// --- 기본 무드 인덱스 (clean) ---

export const DEFAULT_MOOD_INDEX = 1 as const;
