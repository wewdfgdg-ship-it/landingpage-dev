import type { ProductIntelligenceInput } from './types';

// ============================================================
// Product Intelligence Engine — AI 프롬프트
// ============================================================
...
export function buildUserMessage(input: ProductIntelligenceInput): string {
