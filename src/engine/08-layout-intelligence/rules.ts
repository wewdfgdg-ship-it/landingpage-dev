import type { LayoutCategory, LayoutPattern } from './types';

// ============================================================
// Layout Intelligence Engine — 비즈니스 규칙
// ============================================================

// --- 레이아웃 패턴 라이브러리 (~42개) ---

export const PATTERNS: readonly LayoutPattern[] = [
  // Hero (8)
...
export const DEFAULT_CATEGORIES: LayoutCategory[] = ['feature', 'misc'];
...
export const SCORING_WEIGHTS = {
  ...
  decisionTypeMatch: 20,
  decisionTypeDefault: 5,
  contentFit: 15,
  contentNear: 8,
  diversityNew: 10,
...
export const CONTENT_AMOUNT_MAP: Record<string, number> = {
  HOOK: 2,
  PAIN: 3,
  SOLUTION: 4,
  PROOF: 4,
...
export const DEFAULT_CONTENT_AMOUNT = 3 as const;

// --- 기본 모바일 점수 ---

export const DEFAULT_MOBILE_SCORE = 80 as const;
