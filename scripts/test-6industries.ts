...
const skincare = makeData({
  products: {
    headline: '스킨케어 라인업',
    item1: { name: '동백 클렌징 오일', sub: '120ml · 딥 클렌징' },
    item2: { name: '쌀겨 발효 토너', sub: '150ml · 피부결 정돈' },
    item3: { name: '동백 모이스처 크림', sub: '50ml · 깊은 보습' },
    item4: { name: '발효 에센스', sub: '30ml · 톤업 집중' },
  },
  process1: { title: '피부 분석', desc: 'AI가 피부 타입을 분석합니다' },
  process2: { title: '맞춤 추천', desc: '성분 기반 제품을 추천합니다' },
  process3: { title: '냉장 배송', desc: '활성 성분 신선하게 도착' },
  before1: { title: '화학 성분 범벅', desc: '성분 30개+, 뭘 바르는지 모름' },
  before2: { title: '피부 트러블', desc: '자극적 성분으로 반복되는 트러블' },
  before3: { title: '효과 없는 제품', desc: '비싸기만 하고 변화 없음' },
  after1: { title: '성분 10개 미만', desc: '피부에 필요한 것만 담았습니다' },
  after2: { title: '7일 만에 피부결 개선', desc: '자연 발효 성분의 확실한 효과' },
  after3: { title: '냉장 배송 신선함', desc: '활성 성분이 살아있는 제품' },
  reviews: {
    headline: '실제 <em>사용 후기</em>',
    items: [
      { name: '김지현', meta: '27세 · 건성', avatar: 'https://i.pravatar.cc/120?img=32', quote: '동백 오일이 진짜 흡수가 달라요. 기름진 느낌 없이 촉촉.' },
      { name: '이수연', meta: '34세 · 복합성', avatar: 'https://i.pravatar.cc/120?img=45', quote: '발효 에센스 쓰고 톤이 확 올라왔어요.' },
      { name: '박서아', meta: '29세 · 민감성', avatar: 'https://i.pravatar.cc/120?img=47', quote: '민감한 피부인데 자극 없이 순해요.' },
      { name: '정하은', meta: '31세 · 지성', avatar: 'https://i.pravatar.cc/120?img=29', quote: '가볍게 발리는데 보습이 오래 가요.' },
      { name: '최유나', meta: '26세 · 건성', avatar: 'https://i.pravatar.cc/120?img=12', quote: '성분이 단순해서 믿고 쓸 수 있어요.' },
      { name: '한소정', meta: '38세 · 복합성', avatar: 'https://i.pravatar.cc/120?img=60', quote: '남편도 같이 쓰기 시작했어요. 가족 스킨케어.' },
    ],
  },
  images: {
    hero: 'https://images.unsplash.com/photo-1612817288484-6f916006741a?w=1400&q=85',
    feat1: 'https://images.unsplash.com/photo-1596178065887-1198b6148b2b?w=800&q=80',
    feat2: 'https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?w=800&q=80',
    feat3: 'https://images.unsplash.com/photo-1599305090598-fe179d501227?w=800&q=80',
    fullbleed: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=1400&q=85',
    gallery1: 'https://images.unsplash.com/photo-1612817288484-6f916006741a?w=800&q=80',
    gallery2: 'https://images.unsplash.com/photo-1596178065887-1198b6148b2b?w=600&q=80',
    gallery3: 'https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?w=600&q=80',
    gallery4: 'https://images.unsplash.com/photo-1599305090598-fe179d501227?w=600&q=80',
    gallery5: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=800&q=80',
    gallery6: 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?w=800&q=80',
    gallery7: 'https://images.unsplash.com/photo-1619451334792-150fd785ee74?w=800&q=80',
    product1: 'https://images.unsplash.com/photo-1612817288484-6f916006741a?w=600&q=80',
    product2: 'https://images.unsplash.com/photo-1596178065887-1198b6148b2b?w=600&q=80',
    product3: 'https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?w=600&q=80',
    product4: 'https://images.unsplash.com/photo-1599305090598-fe179d501227?w=600&q=80',
  },
  brand: 'HARU BOTANICS',
