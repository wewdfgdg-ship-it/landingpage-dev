...
- 실패 시 Bridge의 Trust→Layout 반영만 불가 (치명적이지 않음)
- resistanceMap + decisionType → trustElements 매칭 규칙
- level 1~6, sectionOrder structure[] 범위 내 클램핑 필수
- 결정론적 출력 (같은 입력 → 같은 출력)
