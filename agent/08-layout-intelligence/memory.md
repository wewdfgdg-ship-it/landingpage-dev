...
- 28+ 레이아웃 패턴을 renderers.ts에서 관리
- patternId 유효성 검증 필수 (renderers.ts에 존재 여부)
- diversityScore ≥ 60 목표, 연속 같은 패턴 금지
- mobileReadyScore ≥ 70 목표
- attentionConfig.zones 기반 Zone 배정
- 실패 시 Bridge enrichedLayout 불가, ⑩ 패턴 매핑 불가
